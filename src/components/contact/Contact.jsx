...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_5i1u9dg', 'template_k2iwlcd', formRef.current, {
  ...
  return (
    <motion.div ref={ref} className="contactform" variants={variants} initial="initial" whileInView="animate">
      ...
      <div className="formContainer">
        ...
        <motion.form onSubmit={sendEmail} ref={formRef} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 2, duration: 1 }} action="">
